...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="pbx-management" tabindex="-1"><a class="header-anchor" href="#pbx-management" aria-hidden="true">#</a> PBX management</h3><p>Endpoint: <code>/api/v2/pbx</code></p><p>Here you can query, create, modify and delete PBXv objects (pbxs, recepcionists, groups, queues, ddis, schedules, holidays).</p><h3 id="monitoring-resources" tabindex="-1"><a class="header-anchor" href="#monitoring-resources" aria-hidden="true">#</a> Monitoring resources</h3><p>Endpoint: <code>/api/v2/monitoring</code></p><ul><li>Obtain current status of monitored hosts and services</li><li>History of changes for them</li><li>Datasets with monitored metrics</li><li>Perform actions (reschedule checks, etc.)</li></ul><h3 id="radius-management" tabindex="-1"><a class="header-anchor" href="#radius-management" aria-hidden="true">#</a> RADIUS management</h3><p>Endpoint: <code>/api/v2/oratio</code></p><p>PPPoE sessions and IP Pool stats information.</p><h3 id="gpon-provision" tabindex="-1"><a class="header-anchor" href="#gpon-provision" aria-hidden="true">#</a> GPON provision</h3><p>Endpoint: <code>/api/v2/gpon</code></p><p>Realtime information about OLTs, PONs and ONUs provisioned.</p><h3 id="docsis-management" tabindex="-1"><a class="header-anchor" href="#docsis-management" aria-hidden="true">#</a> DOCSIS management</h3><p>Endpoint: <code>/api/v2/docsis</code></p><p>Technical information about CMTSs, Macs domains and fiber nodes.</p><h3 id="rubik-resources" tabindex="-1"><a class="header-anchor" href="#rubik-resources" aria-hidden="true">#</a> Rubik resources</h3><p>Endpoint: <code>/api/v2/rubik</code></p><p>Here you can query, create, modify and delete Rubik objects (Addresses, Services, Tickets), for integration with an external CRM.</p><h3 id="plankton-management" tabindex="-1"><a class="header-anchor" href="#plankton-management" aria-hidden="true">#</a> Plankton management</h3><p>Endpoint: <code>/api/v2/plankton</code></p><p>Here you can query, create, modify and delete Plankton FTTH Services, for integration with an external CRM.</p><h2 id="widgets" tabindex="-1"><a class="header-anchor" href="#widgets" aria-hidden="true">#</a> Widgets</h2><h3 id="widget-graphs" tabindex="-1"><a class="header-anchor" href="#widget-graphs" aria-hidden="true">#</a> Widget Graphs</h3><p>Endpoint: <code>/widgets/monitoring/graphs/{graphType}/</code>:</p><p>Graph Types:</p><ul><li><code>bandwidth</code></li><li><code>txrx</code> (GPON tech only)</li><li><code>upstream</code> (DOCSIS tech only)</li><li><code>downstream</code> (DOCSIS tech only)</li><li><code>qos</code> (DOCSIS tech only)</li></ul><p>Query Parameters:</p><ul><li><code>token</code> (required): extracted from login API request or from <code>app_token</code> browser local storage persistence</li><li><code>host_name</code> (required): host name like <code>cpe23133</code> (DOCSIS) or <code>cpe115087</code> (GPON)</li><li><code>realtime</code> (default: <strong>false</strong>): data from realtime info or from influx history</li><li><code>start</code> (default: <strong>1d</strong>): if not realtime, time period from start of request for data sets</li><li><code>end</code> (default: <strong>0m</strong>): if not realtime, time period to end of request data sets</li><li><code>refresh</code> (default: <strong>60 secs</strong>): if realtime, integer value for refresh interval between requests (in seconds)</li></ul><p>Time Periods:</p><ul><li>Time periods are strings with magnitude &amp; unit, like <code>24h</code> or <code>7d</code></li><li>Valid units are: <code>M</code> for months, <code>d</code> for days, <code>h</code> for hours and <code>m</code> for minutes</li></ul><p>Examples:</p><ul><li>Realtime Bandwidth chart for cpe23133 with refresh every 30 secs: <code>https://xxx.phicus.es/widgets/monitoring/graphs/bandwidth/?host_name=cpe23133&amp;realtime=true&amp;refresh=30&amp;token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjgwNzcxNjkzLCJpYXQiOjE2ODA2ODUyOTMsImp0aSI6ImU1NzdlNjc1OGU5YTQ2ODhhNmMwZjEwNDE0ODUwMTNkIiwidXNlcl9pZCI6NX0.mUJQ3EiHfMTKnKrZSYApJ-9VAOJJmMLv7zr1aeN2uYo</code></li><li>Downstream chart for DOCSIS cpe23133 host for last 7 days: <code>https://xxx.phicus.es/widgets/monitoring/graphs/downstream/?host_name=cpe23133&amp;start=7d&amp;token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjgwNzcxNjkzLCJpYXQiOjE2ODA2ODUyOTMsImp0aSI6ImU1NzdlNjc1OGU5YTQ2ODhhNmMwZjEwNDE0ODUwMTNkIiwidXNlcl9pZCI6NX0.mUJQ3EiHfMTKnKrZSYApJ-9VAOJJmMLv7zr1aeN2uYo</code></li><li>TxRx chart for GPON cpe115087 host for last 24 hours: <code>https://xxx.phicus.es/widgets/monitoring/graphs/txrx/?host_name=cpe115087&amp;start=24h&amp;token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjgwNzcxNjkzLCJpYXQiOjE2ODA2ODUyOTMsImp0aSI6ImU1NzdlNjc1OGU5YTQ2ODhhNmMwZjEwNDE0ODUwMTNkIiwidXNlcl9pZCI6NX0.mUJQ3EiHfMTKnKrZSYApJ-9VAOJJmMLv7zr1aeN2uYo</code></li></ul><h3 id="widget-device" tabindex="-1"><a class="header-anchor" href="#widget-device" aria-hidden="true">#</a> Widget Device</h3><p>Endpoints: <code>/widgets/monitoring/device/</code>:</p><p>Query Parameters:</p><ul><li><code>token</code> (required): extracted from login API request or from <code>app_token</code> browser local storage persistence</li><li><code>host_name</code> (required): host name like <code>cpe23133</code> (DOCSIS) or <code>cpe115087</code> (GPON)</li></ul><p>Examples:</p><ul><li>Device representation for cpe8317: <code>https://xxx.phicus.es/widgets/monitoring/device/?host_name=cpe8317&amp;token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjgwNzcxNjkzLCJpYXQiOjE2ODA2ODUyOTMsImp0aSI6ImU1NzdlNjc1OGU5YTQ2ODhhNmMwZjEwNDE0ODUwMTNkIiwidXNlcl9pZCI6NX0.mUJQ3EiHfMTKnKrZSYApJ-9VAOJJmMLv7zr1aeN2uYo</code></li></ul>`,56);function w(_,x){const a=l("ExternalLinkIcon");return o(),c("div",null,[u,r,s("p",null,[n("The "),s("a",d,[n("REST"),e(a)]),n(" API v2 allows you to manage Krill objects and resources by HTTP requests.")]),s("p",null,[n("You can check the technical definition "),s("a",m,[n("here (Swagger)"),e(a)]),n(".")]),v,s("ul",null,[b,k,q,g,s("li",null,[n("if you need it, auth now may include "),s("a",h,[n("OAuth"),e(a)]),n(". Please, contact Phicus team for details.")])]),f])}const O=t(p,[["render",w],["__file","api-v2.html.vue"]]);export{O as default};
