...
<span class="token punctuation">[</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">]</span>
</code></pre><p>With v2</p><pre><code class="language-bash">GET api/v2/isp/cpes/?sn<span class="token operator">=</span>0000deadbeef0000
...
</code></pre><p>Changes about urls and paginated response are the same for <code>customers</code> and <code>potses</code> resources.</p><h2 id="hierarchy" tabindex="-1"><a class="header-anchor" href="#hierarchy"><span>Hierarchy</span></a></h2><p>Krill&#39;s entire REST API is organized under <code>https://&lt;hostname&gt;/api/v2/</code>. The URL structure is divided at the root level by some of these applications: isp, pbx, monitoring, auth, me, installer, oratio, rubik and plankton. Within each application exists diferent resources to use.</p><h2 id="endpoints" tabindex="-1"><a class="header-anchor" href="#endpoints"><span>Endpoints</span></a></h2><h3 id="crm" tabindex="-1"><a class="header-anchor" href="#crm"><span>CRM</span></a></h3><p>Endpoint: <code>/api/v2/isp</code></p><p>Here you can query, create, modify and delete CRM objects (Customers, CPEs, POTSs).</p><h4 id="filtering-attributes" tabindex="-1"><a class="header-anchor" href="#filtering-attributes"><span>Filtering attributes</span></a></h4><pre><code class="language-bash">GET api/v2/isp/cpes/74/?attrs<span class="token operator">=</span>id,cpename
