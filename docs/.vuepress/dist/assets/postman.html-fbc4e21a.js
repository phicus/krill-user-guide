import{_ as t,a as o,b as u,c as n,d as q,e}from"./get_datasets-8b18457a.js";import{_ as i,o as a,c as r,a as s}from"./app-dfe735a8.js";const l={},p=s(`<h1 id="ejemplos-de-la-api-rest-v2-en-postman" tabindex="-1"><a class="header-anchor" href="#ejemplos-de-la-api-rest-v2-en-postman"><span>Ejemplos de la API REST v2 en Postman</span></a></h1><h2 id="consultar-un-cpe-por-su-external-id-y-obtener-su-id" tabindex="-1"><a class="header-anchor" href="#consultar-un-cpe-por-su-external-id-y-obtener-su-id"><span>Consultar un cpe por su <code>external_id</code> y obtener su id</span></a></h2><p>Método: <strong>GET</strong></p><p>URL: <code>/api/v2/isp/cpes/?external_id={external_id}&amp;realm={realm}</code></p><p>Los parámetros: <code>external_id</code>, <code>realm</code>, son opcionales y nos permiten acotar la lista de resultados. Es decir, si ponemos solamente el valor del <code>realm</code>, obtendremos un listado paginado con todos los CPEs de ese Realm.</p><p>Respuesta (Ejemplo: <code>/api/v2/isp/cpes/?external_id=pim0585&amp;realm=pim</code>)):</p><pre><code>{
  &quot;count&quot;: 1,
  &quot;next&quot;: null,
  &quot;previous&quot;: null,
  &quot;results&quot;: [
...
</code></pre><p><img src="`+t+`" alt="image"></p><h2 id="monitorizacion-en-tiempo-real-de-un-equipo" tabindex="-1"><a class="header-anchor" href="#monitorizacion-en-tiempo-real-de-un-equipo"><span>Monitorización en tiempo real de un equipo</span></a></h2><p>Método: <strong>GET</strong></p><p>URL: <code>/api/v2/monitoring/cpes/{id}/info</code></p><p>Nota: El campo <code>id</code>, se encuentra dentro de los atributos que devuelve la petición anterior.</p><p>Respuesta (Ejemplo: <code>/api/v2/monitoring/cpes/585/info</code>):</p><pre><code>{
  &quot;alarms&quot;: [
    {
      &quot;level&quot;: &quot;warning&quot;,
      &quot;type&quot;: &quot;processerror&quot;,
...
</code></pre><p><img src="`+u+`" alt="image"></p><h2 id="obtener-los-tipos-de-graficas-de-un-host" tabindex="-1"><a class="header-anchor" href="#obtener-los-tipos-de-graficas-de-un-host"><span>Obtener los tipos de gráficas de un host</span></a></h2><p>Método: <strong>GET</strong></p><p>URL: <code>/api/v2/monitoring/graphs/?host_name={internal_id|host_name}</code></p><p>Nota: El campo <code>internal_id</code>, se encuentra dentro de los atributos que devuelve la petición anterior. También puede usarse el nombre del host en caso de ser un equipo de core.</p><p>Respuesta (Ejemplo: <code>/api/v2/monitoring/graphs/?host_name=pim0585</code>):</p><pre><code>{
  &quot;graphs&quot;: [
    {
      &quot;group&quot;: &quot;bandwidth&quot;,
      &quot;severity&quot;: 0,
...
</code></pre><p><img src="`+n+`" alt="image"></p><h2 id="obtener-los-tipos-de-graficas-de-un-servicio-de-un-host" tabindex="-1"><a class="header-anchor" href="#obtener-los-tipos-de-graficas-de-un-servicio-de-un-host"><span>Obtener los tipos de gráficas de un servicio de un host</span></a></h2><p>Método: <strong>GET</strong></p><p>URL: <code>/api/v2/monitoring/graphs/?host_name={internal_id|host_name}&amp;service_name={service_name}</code></p><p>Nota: El campo <code>internal_id</code>, se encuentra dentro de los atributos que devuelve la petición anterior. También puede usarse el nombre del host en caso de ser un equipo de core.</p><p>Respuesta (Ejemplo: <code>/api/v2/monitoring/graphs/?host_name=pim0585&amp;service_name=txrx</code>):</p><pre><code>{
  &quot;graphs&quot;: [
    {
      &quot;group&quot;: &quot;dnatt Graph.&quot;,
      &quot;severity&quot;: 50,
...
</code></pre><p><img src="`+q+`" alt="image"></p><h2 id="obtencion-de-metricas-de-una-grafica-determinada-en-un-periodo-de-tiempo" tabindex="-1"><a class="header-anchor" href="#obtencion-de-metricas-de-una-grafica-determinada-en-un-periodo-de-tiempo"><span>Obtención de métricas de una gráfica determinada en un periodo de tiempo</span></a></h2><p>Para cada gráfica devuelta en el endpoint anterior, se puede peticionar las métricas dentro de un intervalo determinado de tiempo para los diferentes datasets.</p><p>Si para una gráfica existen varios datasets disponibles, éstos se podrán pedir de forma simultánea.</p><p>Método: <strong>POST</strong></p><p>URL: <code>/api/v2/monitoring/datasets/</code></p><p>Request:</p><pre><code>{
...
</code></pre><p><code>time_magnitude</code>: Valor compuesto de unidades y magnitud de tiempo, por ejemplo: 24h para las últimas 24 horas. Las magnitudes permitidas son: [m]minutos, [h]hora, [d]ías <code>measurement</code>: Extraído del array de datasets de la petición de gráficas. <code>metric</code>: Extraído del array de datasets de la petición de gráficas.</p><p>Request de ejemplo:</p><pre><code>{
  &quot;host_name&quot;:&quot;pim0585&quot;,
  &quot;service_name&quot;:&quot;txrx&quot;
  &quot;start&quot;:&quot;24h&quot;,
  &quot;end&quot;:&quot;0m&quot;,
