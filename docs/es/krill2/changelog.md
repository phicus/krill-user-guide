 ...
 * Mejora en tiempo de las peticiones de los tickets de Rubik.
 * Mejoras de rendimiento en las consultas de remote_id e external_id.
 * Inclusión de un nuevo de formato de índice SNMP en las OLTs Cdata
 * Corregimos un bug por el que en algunos casos mostrábamos el estado "_invalid_" de las ONUs Huawei.
 ...
 * Solventado bug en busqueda del campo topology con gis activado
### Krill-UI
 ...
 * Paginacion en Oratio ippools

 ### Krill-UI
 * Arreglado un error por el cual no se permitía crear CPEs sin Serial Number desde la vista de crear customer.
 ...
 * Optimización de la monitorización del modelo TP-Link EC220-G5.
 * Solventada incompatibilidad Ubuntu 24.05 y CGNAT logger.
 * Implementación del diagnóstico WiFi Neighboring para el modelo Nokia G-0126G-A.
 * API isp/cpes: al cambiar address_profile de fixed a otro valor, ahora se vacía el campo fixed_address.
